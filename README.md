...
[![Version](https://img.shields.io/badge/version-1.10.1-orange.svg)](https://github.com/eduardo-w-bandeira/databarn)
...
```bash
pip install git+https://github.com/eduardo-w-bandeira/databarn.git@v1.10.1
```
