...
def create_child_barn_grain(label: str = "", frozen: bool = True, **grain_kwargs):
    ...
    def decorator(child_model: Type[Cob]):
        ...
        grain._set_child_model(child_model)
        child_model.__dna__._set_affiliation(outer_model_grain=grain, is_embedded_in_child_barn=True)
        return child_model
    return decorator
...
def create_child_cob_grain(label: str = "", **grain_kwargs):
    ...
    def decorator(child_model: Type[Cob]):
        ...
        grain._set_child_model(child_model)
        child_model.__dna__._set_affiliation(outer_model_grain=grain, is_embedded_in_child_barn=False)
        return child_model
    return decorator
