...
class BaseDna:
    ...
    @dual_method
    def _embed_grain(owner, label: str, grain: _type[BaseGrain] | BaseGrain) -> None:
    ...
    def __init__(self, cob: "Cob") -> None:  # type: ignore
        ...
        for grain in self.__class__.grains:
            ...
            self._embed_grain(grain.label, grainob)
    ...
    def update(self,
               other: Mapping[str, Any] | Iterable[tuple[Any, Any]
