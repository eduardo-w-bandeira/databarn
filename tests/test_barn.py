...
class TestBarnUniqueConstraints:
    ...
    def test_unique_constraint_validation(self):
        ...
        person2 = Person(id=2, email="alice@example.com", name="Bob")  # Same email
...
class TestBarnParentChildRelationships:
    ...
    def test_add_parent_cob(self):
        ...
        child1 = Person(id=2, name="Child1")
    ...
    def test_add_parent_cob_when_already_has_parent_raises_error(self):
        ...
        parent1 = Person(id=1, name="Parent1")
    ...
    def test_remove_parent_cob(self):
        ...
        child_barn._remove_parent_cob()
        
        assert child_barn.parent_cob is None
